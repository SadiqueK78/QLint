...
// TypeScript, and Go: it branches on whether a snippet carries the two
...
// with the language (# in Python, // in Go, JavaScript, and TypeScript).
...
// flat panel. Matching the label alone is what makes one renderer serve all
// four languages.
